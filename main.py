...
moneyDB = pd.DataFrame.from_dict({"years": [], "months": [], "days": [], "wallet": [], "drawer": [],
                                  "bank": []}).astype("int64")
moneyDB = moneyDB.append({"years": 2020, "months": 8, "days": 31,
                          "wallet": 100, "drawer": 100,
                          "bank": 100}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 8, "days": 30,
                          "wallet": 200, "drawer": 200,
                          "bank": 200}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 9, "days": 10,
                          "wallet": 300, "drawer": 300,
                          "bank": 300}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 9, "days": 15,
                          "wallet": 400, "drawer": 400,
                          "bank": 400}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 7, "days": 5,
                          "wallet": 300, "drawer": 300,
                          "bank": 300}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 7, "days": 17,
                          "wallet": 400, "drawer": 400,
                          "bank": 400}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 7, "days": 18,
                          "wallet": 400, "drawer": 400,
                          "bank": 400}, ignore_index=True)
moneyDB = moneyDB.append({"years": 2020, "months": 6, "days": 5,
                          "wallet": 400, "drawer": 400,
                          "bank": 400}, ignore_index=True)
